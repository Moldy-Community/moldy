...
$packageArgs = @{
  ...
  softwareName  = 'Moldy*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
Install-ChocolateyZipPackage -PackageName 'moldy' `
 -Url 'https://github.com/Moldy-Community/moldy/releases/download/v0.0.1-beta/moldy-v0.0.1-beta-x64_windows.zip' `
 -UnzipLocation "$(Split-Path -Parent $MyInvocation.MyCommand.Definition)" `
 -Url64 'https://github.com/Moldy-Community/moldy/releases/download/v0.0.1-beta/moldy-v0.0.1-beta-x64_windows.zip'
